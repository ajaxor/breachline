...
import { FinaleFadeBattlefieldRenderer } from './frontend/FinaleFadeBattlefieldRenderer.js';
...
const renderer = new FinaleFadeBattlefieldRenderer(view.elements.field, view.elements.fieldWrap);
