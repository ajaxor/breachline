...
const drawUnitDetails = (ctx, graphic, radius) => {
  ...
  drawLegacyUnitDetails(ctx, graphic, radius);
};

const drawLegacyUnitDetails = (ctx, graphic, radius) => {
...
function drawBulwarkSymbol(ctx, radius) {
  ...
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(-radius * 0.28, -radius * 0.08); ctx.lineTo(0, radius * 0.04); ctx.lineTo(radius * 0.28, -radius * 0.08);
  ctx.moveTo(-radius * 0.24, radius * 0.18); ctx.lineTo(0, radius * 0.3); ctx.lineTo(radius * 0.24, radius * 0.18);
  ctx.stroke();
  ctx.restore();
}
...
function drawMarksmanSymbol(ctx, radius) {
  ...
  ctx.beginPath();
  ctx.moveTo(-radius * 0.52, -radius * 0.22); ctx.lineTo(-radius * 0.52, -radius * 0.46); ctx.lineTo(-radius * 0.28, -radius * 0.46);
  ctx.moveTo(radius * 0.52, -radius * 0.22); ctx.lineTo(radius * 0.52, -radius * 0.46); ctx.lineTo(radius * 0.28, -radius * 0.46);
  ctx.moveTo(-radius * 0.52, radius * 0.22); ctx.lineTo(-radius * 0.52, radius * 0.46); ctx.lineTo(-radius * 0.28, radius * 0.46);
  ctx.moveTo(radius * 0.52, radius * 0.22); ctx.lineTo(radius * 0.52, radius * 0.46); ctx.lineTo(radius * 0.28, radius * 0.46);
  ctx.arc(0, 0, radius * 0.2, 0, Math.PI * 2);
...
function drawFusilierSymbol(ctx, radius) {
  ...
  ctx.beginPath();
  ctx.moveTo(-radius * 0.46, -radius * 0.28); ctx.lineTo(0, -radius * 0.08); ctx.lineTo(radius * 0.46, -radius * 0.28);
  ctx.moveTo(-radius * 0.46, 0); ctx.lineTo(0, radius * 0.2); ctx.lineTo(radius * 0.46, 0);
  ctx.moveTo(-radius * 0.46, radius * 0.28); ctx.lineTo(0, radius * 0.48); ctx.lineTo(radius * 0.46, radius * 0.28);
  ctx.stroke();
  ctx.restore();
}
...
function drawAmplifierSymbol(ctx, radius) {
  ...
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(0, radius * 0.18); ctx.lineTo(0, radius * 0.46);
  ctx.stroke();
  ctx.restore();
}
