...
export const UNIT_TYPES = Object.freeze({
  grunt: unit({ key: 'grunt', name: 'Rifleman', role: UNIT_ROLE.GRUNT, cost: 20, hp: 40, attack: 9, range: 1, campaign: { unlockMission: 0, initialWeight: 1 }, behavior: 'A dependable lane fighter who stops behind anything in the way.', shape: 'square', graphic: 'rifleman' }),
  tank: unit({ key: 'tank', name: 'Bulwark', role: UNIT_ROLE.GRUNT, cost: 40, hp: 100, attack: 15, range: 1, campaign: { unlockMission: 2, initialWeight: 0.24, weightGrowth: 0.04 }, behavior: 'A heavily armored front-line unit built to hold a lane.', shape: 'hex', graphic: 'bulwark' }),
  sniper: unit({ key: 'sniper', name: 'Marksman', role: UNIT_ROLE.RANGED, cost: 32, hp: 22, attack: 14, range: 4, campaign: { unlockMission: 1, initialWeight: 0.34, weightGrowth: 0.04 }, behavior: 'Engages distant targets that remain in the same lane.', shape: 'triangle', graphic: 'marksman' }),
  bomber: unit({ key: 'bomber', name: 'Demolisher', role: UNIT_ROLE.SPECIALIST, cost: 29, hp: 25, attack: 26, range: 1, onAttack: ATTACK_EFFECT.DETONATE, campaign: { unlockMission: 3, initialWeight: 0.2, weightGrowth: 0.04 }, behavior: 'Detonates on contact and damages every adjacent foe.', shape: 'diamond', graphic: 'demolisher' }),
  ...
  midge: unit({ key: 'midge', name: 'Midge', role: UNIT_ROLE.FLYING, cost: 18, hp: 12, attack: 5, range: 1, tags: [UNIT_TAG.FLYING], campaign: { unlockMission: 5, initialWeight: 0.13, weightGrowth: 0.025 }, behavior: 'A cheap swarm flyer that slips through formations and pecks at targets in its lane.', shape: 'wing', graphic: 'wasp' }),
  ...
  kite: unit({ key: 'kite', name: 'Kite', role: UNIT_ROLE.FLYING, cost: 38, hp: 16, attack: 12, range: 4, tags: [UNIT_TAG.FLYING], campaign: { unlockMission: 7, initialWeight: 0.13, weightGrowth: 0.025 }, behavior: 'A fragile long-range flyer that fires down its lane while continuously advancing.', shape: 'wing', graphic: 'wasp' }),
  ...
  mortar: unit({ key: 'mortar', name: 'Artillery', role: UNIT_ROLE.RANGED, cost: 40, hp: 28, attack: 19, range: 3, tags: [UNIT_TAG.ATTACKS_OTHER_LANES], campaign: { unlockMission: 7, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'Bombards any target within range, regardless of lane.', shape: 'star', graphic: 'artillery' }),
