...
export const UNIT_TYPES = Object.freeze({
  ...
  stormwing: unit({ key: 'stormwing', name: 'Stormwing', role: UNIT_ROLE.FLYING, techLevel: 3, cost: 58, hp: 14, attack: 4, range: 3, tags: [UNIT_TAG.STUN, UNIT_TAG.SALVO, UNIT_TAG.ANTI_AIR, UNIT_TAG.SWIVEL], campaign: { unlockMission: 5, initialWeight: 0.11, weightGrowth: 0.022 }, behavior: 'A flying anti-air disruptor that fires lightning at every valid ground and flying target within range. Each hit stuns its target for two turns.', graphic: 'stormwing' }),
