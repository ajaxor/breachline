...
export const UNIT_TAG = Object.freeze({
  AGILE: 'agile', STATIONARY: 'stationary', SWIVEL: 'swivel', FAST_ATTACK: 'fast-attack', STEALTH: 'stealth', AI_ONLY: 'ai-only', PLAYER_ONLY: 'player-only', FLYING: 'flying', ANTI_AIR: 'anti-air', BOMB: 'bomb', AOE: 'aoe', HEAL: 'heal', SHIELD: 'shield', ENHANCE: 'enhance', STUN_FIELD: 'stun-field', JAMMER: 'jammer', SALVO: 'salvo', PUSH: 'push', RAM: 'ram', CHARGE: 'charge', RELOAD: 'reload', FORMATION: 'formation', THORNS: 'thorns', FACTORY: 'factory', SCATTER: 'scatter',
});
...
export const UNIT_TYPES = Object.freeze({
  ...
  swarmer: unit({ key: 'swarmer', name: 'Swarmer', role: UNIT_ROLE.MELEE, techLevel: 1, cost: 9, hp: 18, attack: 4, range: 1, campaign: { unlockMission: 0, initialWeight: 0.28, weightGrowth: 0.01 }, behavior: 'A very cheap melee fighter that relies on numbers instead of durability or damage.', graphic: 'skitter' }),
  ...
  archer: unit({ key: 'archer', name: 'Archer', role: UNIT_ROLE.RANGED, techLevel: 1, cost: 15, hp: 18, attack: 8, range: 3, tags: [UNIT_TAG.RELOAD], campaign: { unlockMission: 0, initialWeight: 0.28, weightGrowth: 0.015 }, behavior: 'A cheap mid-range attacker that fires a useful shot, then spends two turns reloading.', graphic: 'marksman' }),
  ...
  dozer: unit({ key: 'dozer', name: 'Dozer', role: UNIT_ROLE.SPECIALIST, techLevel: 2, cost: 30, hp: 64, attack: 0, range: 1, tags: [UNIT_TAG.PUSH, UNIT_TAG.PLAYER_ONLY], campaign: { unlockMission: 0, initialWeight: 0.13, weightGrowth: 0.035 }, behavior: 'Pushes an adjacent enemy backward and advances into the space it leaves.', graphic: 'ram' }),
  ram: unit({ key: 'ram', name: 'Ram', role: UNIT_ROLE.SPECIALIST, techLevel: 2, cost: 24, hp: 52, attack: 0, range: 1, tags: [UNIT_TAG.RAM, UNIT_TAG.PLAYER_ONLY], campaign: { unlockMission: 1, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'Smashes enemy walls by moving into them, destroying the wall and taking its space instead of stopping.', graphic: 'ram' }),
  ...
  commander: unit({ key: 'commander', name: 'Commander', role: UNIT_ROLE.MELEE, techLevel: 3, cost: 72, hp: 108, attack: 18, range: 1, aura: { effect: AURA_EFFECT.DAMAGE, range: 2, value: 3 }, tags: [UNIT_TAG.ENHANCE], campaign: { unlockMission: 5, initialWeight: 0.08, weightGrowth: 0.018 }, behavior: 'An elite melee leader with heavy front-line stats who amplifies the attacks of nearby allies. Multiple damage boosts do not stack.', graphic: 'bulwark' }),
  ...
  fusilier: unit({ key: 'fusilier', name: 'Fusilier', role: UNIT_ROLE.RANGED, techLevel: 3, cost: 34, hp: 30, attack: 10, range: 3, tags: [UNIT_TAG.FORMATION], campaign: { unlockMission: 4, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'A formation rifle unit that stays in lock step with allied Formation units.', graphic: 'fusilier' }),
  needler: unit({ key: 'needler', name: 'Needler', role: UNIT_ROLE.RANGED, techLevel: 2, cost: 32, hp: 22, attack: 5, range: 3, tags: [UNIT_TAG.SALVO], campaign: { unlockMission: 3, initialWeight: 0.16, weightGrowth: 0.03 }, behavior: 'A fragile ranged unit that sprays low-damage shots at every valid enemy in its lane.', graphic: 'fusilier' }),
  hydra: unit({ key: 'hydra', name: 'Hydra', role: UNIT_ROLE.RANGED, techLevel: 3, cost: 50, hp: 24, attack: 6, range: 3, tags: [UNIT_TAG.SALVO, UNIT_TAG.SWIVEL], campaign: { unlockMission: 5, initialWeight: 0.1, weightGrowth: 0.022 }, behavior: 'A late-tech multi-headed gun that swivels across lanes and fires low-damage shots at every valid enemy in range.', graphic: 'flak' }),
  ...
  shieldGenerator: unit({ key: 'shieldGenerator', name: 'Aegis', role: UNIT_ROLE.SUPPORT, techLevel: 3, cost: 35, hp: 40, attack: 0, range: 2, aura: { effect: AURA_EFFECT.SHIELD, range: 2, value: 4 }, tags: [UNIT_TAG.SHIELD], campaign: { unlockMission: 4, initialWeight: 0.13, weightGrowth: 0.025 }, behavior: 'Reduces every hit against friendly units within two cells by 4 damage. Multiple shield fields do not stack.', graphic: 'aegis' }),
  ...
  disruptor: unit({ key: 'disruptor', name: 'Disruptor', role: UNIT_ROLE.SUPPORT, techLevel: 3, cost: 40, hp: 28, attack: 0, range: 2, aura: { effect: AURA_EFFECT.STUN, range: 2, value: 1 }, tags: [UNIT_TAG.STUN_FIELD], campaign: { unlockMission: 5, initialWeight: 0.1, weightGrowth: 0.02 }, behavior: 'Stuns enemy units across the same battlefield row for two turns. The stun lingers briefly after they leave the row.', graphic: 'disruptor' }),
  ...
  mortar: unit({ key: 'mortar', name: 'Arty', role: UNIT_ROLE.RANGED, techLevel: 3, cost: 39, hp: 24, attack: 17, range: 3, tags: [UNIT_TAG.SWIVEL], campaign: { unlockMission: 5, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'Bombards ground targets within range by swiveling across lanes.', graphic: 'artillery' }),
