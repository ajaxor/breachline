...
export const UNIT_TYPES = Object.freeze({
  ...
  teslaCoil: unit({ key: 'teslaCoil', name: 'Tesla Coil', role: UNIT_ROLE.STRUCTURE, techLevel: 3, cost: 76, hp: 120, attack: 8, range: 2, tags: [UNIT_TAG.SALVO, UNIT_TAG.SWIVEL, UNIT_TAG.ANTI_AIR], animation: { attack: ATTACK_ANIMATION.LIGHTNING }, campaign: { unlockMission: 5, initialWeight: 0.1, weightGrowth: 0.022 }, behavior: 'A close-defense coil that arcs low damage into every ground and flying target within range.', graphic: 'tesla-coil' }),
