...
export const UNIT_TYPES = Object.freeze({
  ...
  flyer: unit({ key: 'flyer', name: 'Wasp', role: UNIT_ROLE.TROOPER, cost: 36, hp: 28, attack: 11, range: 2, moveInterval: 1, tags: [UNIT_TAG.FLYING, UNIT_TAG.ATTACK_SIDEWAYS, UNIT_TAG.FAST_ATTACK], behavior: 'Flies over occupied cells and can attack after moving.', shape: 'wing', graphic: 'wasp' }),
