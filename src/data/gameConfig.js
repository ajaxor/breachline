...
export const UNIT_TYPES = Object.freeze({
  ...
  disruptor: unit({ key: 'disruptor', name: 'Disruptor', role: UNIT_ROLE.SUPPORT, techLevel: 3, cost: 48, hp: 28, attack: 3, range: 3, tags: [UNIT_TAG.STUN, UNIT_TAG.SALVO, UNIT_TAG.SWIVEL], campaign: { unlockMission: 5, initialWeight: 0.1, weightGrowth: 0.02 }, behavior: 'Fires lightning at every valid enemy within range. Each hit stuns its target for two turns.', graphic: 'disruptor' }),
