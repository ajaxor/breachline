...
export const UNIT_TYPES = Object.freeze({
  ...
  corpsman: unit({ key: 'corpsman', name: 'Corpsman', role: UNIT_ROLE.SUPPORT, cost: 27, hp: 48, attack: 0, range: 1, healAmount: 20, action: UNIT_ACTION.HEAL, tags: [UNIT_TAG.HEAL, UNIT_TAG.SWIVEL], campaign: { unlockMission: 5, initialWeight: 0.12, weightGrowth: 0.025 }, behavior: 'A durable close-support healer with a powerful repair pulse for tightly packed formations.', graphic: 'medic' }),
  relay: unit({ key: 'relay', name: 'Relay', role: UNIT_ROLE.SUPPORT, cost: 24, hp: 24, attack: 0, range: 4, healAmount: 7, action: UNIT_ACTION.HEAL, tags: [UNIT_TAG.HEAL, UNIT_TAG.SWIVEL], campaign: { unlockMission: 6, initialWeight: 0.11, weightGrowth: 0.025 }, behavior: 'A fragile long-range support platform that can sustain widely spaced allies from the rear.', graphic: 'medic' }),
