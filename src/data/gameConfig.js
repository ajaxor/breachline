...
export const UNIT_TAG = Object.freeze({
  AGILE: 'agile', STATIONARY: 'stationary', SWIVEL: 'swivel', FAST_ATTACK: 'fast-attack', STEALTH: 'stealth', AI_ONLY: 'ai-only', PLAYER_ONLY: 'player-only', FLYING: 'flying', ANTI_AIR: 'anti-air', BOMB: 'bomb', AOE: 'aoe', HEAL: 'heal', SHIELD: 'shield', ENHANCE: 'enhance', LEADER: 'leader', STUN_FIELD: 'stun-field', JAMMER: 'jammer', SALVO: 'salvo', PUSH: 'push', RAM: 'ram', CHARGE: 'charge', RELOAD: 'reload', FORMATION: 'formation', THORNS: 'thorns', FACTORY: 'factory', SCATTER: 'scatter', CLEAVE: 'cleave',
});
...
export const UNIT_TYPES = Object.freeze({
  ...
  reaper: unit({ key: 'reaper', name: 'Reaper', role: UNIT_ROLE.MELEE, techLevel: 2, cost: 34, hp: 46, attack: 12, range: 1, tags: [UNIT_TAG.CLEAVE], campaign: { unlockMission: 2, initialWeight: 0.16, weightGrowth: 0.03 }, behavior: 'A broad-swinging melee fighter whose attacks also cut enemies immediately beside its target.', graphic: 'rifleman' }),
  pike: unit({ key: 'pike', name: 'Pike', role: UNIT_ROLE.MELEE, techLevel: 2, cost: 34, hp: 86, attack: 6, range: 1, tags: [UNIT_TAG.FORMATION], campaign: { unlockMission: 2, initialWeight: 0.17, weightGrowth: 0.03 }, behavior: 'A heavily protected formation fighter with very high durability and deliberately low attack power.', graphic: 'phalanx' }),
  ...
  stormwing: unit({ key: 'stormwing', name: 'Stormwing', role: UNIT_ROLE.FLYING, techLevel: 3, cost: 48, hp: 14, attack: 0, range: 2, aura: { effect: AURA_EFFECT.STUN, range: 2, value: 1 }, tags: [UNIT_TAG.STUN_FIELD, UNIT_TAG.ANTI_AIR, UNIT_TAG.SWIVEL], campaign: { unlockMission: 5, initialWeight: 0.11, weightGrowth: 0.022 }, behavior: 'A flying anti-air disruptor that stuns ground and flying enemies across its battlefield row and the row behind it.', graphic: 'stormwing' }),
  ...
  mine: unit({ key: 'mine', name: 'Mine', role: UNIT_ROLE.STRUCTURE, techLevel: 2, cost: 28, hp: 18, attack: 44, range: 1, tags: [UNIT_TAG.BOMB, UNIT_TAG.AOE], campaign: { unlockMission: 2, initialWeight: 0.12, weightGrowth: 0.025 }, behavior: 'A fragile enemy-only explosive trap that detonates on contact or destruction and damages adjacent enemies.', graphic: 'demolisher' }),
  ...
  teslaCoil: unit({ key: 'teslaCoil', name: 'Tesla Coil', role: UNIT_ROLE.STRUCTURE, techLevel: 3, cost: 76, hp: 120, attack: 8, range: 2, tags: [UNIT_TAG.SALVO, UNIT_TAG.SWIVEL, UNIT_TAG.ANTI_AIR], campaign: { unlockMission: 5, initialWeight: 0.1, weightGrowth: 0.022 }, behavior: 'A close-defense coil that arcs low damage into every ground and flying target within range.', graphic: 'disruptor' }),
