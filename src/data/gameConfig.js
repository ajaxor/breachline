...
export const UNIT_TYPES = Object.freeze({
  ...
  disruptor: unit({ key: 'disruptor', name: 'Disruptor', role: UNIT_ROLE.SUPPORT, techLevel: 5, cost: 40, hp: 28, attack: 0, range: 2, aura: { effect: AURA_EFFECT.STUN, range: 2, value: 1 }, tags: [UNIT_TAG.STUN_FIELD], campaign: { unlockMission: 7, initialWeight: 0.1, weightGrowth: 0.02 }, behavior: 'Stuns enemy units across the same battlefield row for two turns. The stun lingers briefly after they leave the row.', graphic: 'disruptor' }),
  jammer: unit({ key: 'jammer', name: 'Jammer', role: UNIT_ROLE.SUPPORT, techLevel: 5, cost: 32, hp: 26, attack: 0, range: 2, aura: { effect: AURA_EFFECT.STEALTH, range: 2, value: 1 }, tags: [UNIT_TAG.JAMMER], campaign: { unlockMission: 7, initialWeight: 0.11, weightGrowth: 0.025 }, behavior: 'Cloaks friendly units within two cells. Cloaked units can still be targeted by adjacent enemies.', graphic: 'jammer' }),
  sidestepper: unit({ key: 'sidestepper', name: 'Ranger', role: UNIT_ROLE.SPECIALIST, techLevel: 2, cost: 25, hp: 34, attack: 9, range: 2, tags: [UNIT_TAG.AGILE, UNIT_TAG.SWIVEL], campaign: { unlockMission: 3, initialWeight: 0.2, weightGrowth: 0.04 }, behavior: 'Dodges the first attack by slipping into an open adjacent lane, and can swivel toward targets in other lanes.', graphic: 'ranger', animation: { attack: ATTACK_ANIMATION.LASER } }),
  infiltrator: unit({ key: 'infiltrator', name: 'Infiltrator', role: UNIT_ROLE.SPECIALIST, techLevel: 4, cost: 28, hp: 24, attack: 12, range: 1, tags: [UNIT_TAG.AGILE, UNIT_TAG.STEALTH], campaign: { unlockMission: 5, initialWeight: 0.16, weightGrowth: 0.03 }, behavior: 'Dodges the first attack by slipping into an open adjacent lane and remains untargetable until an enemy becomes adjacent.', graphic: 'infiltrator' }),
