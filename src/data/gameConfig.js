...
export const UNIT_TYPES = Object.freeze({
  ...
  healer: unit({ key: 'healer', name: 'Medic', role: UNIT_ROLE.SUPPORT, cost: 22, hp: 34, attack: 0, range: 2, healAmount: 12, action: UNIT_ACTION.HEAL, tags: [UNIT_TAG.HEAL, UNIT_TAG.ATTACKS_OTHER_LANES], campaign: { unlockMission: 4, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'Repairs the nearest damaged ally within range, regardless of lane.', graphic: 'medic' }),
  ...
  firefly: unit({ key: 'firefly', name: 'Firefly', role: UNIT_ROLE.FLYING, cost: 28, hp: 14, attack: 30, range: 1, tags: [UNIT_TAG.FLYING, UNIT_TAG.BOMB, UNIT_TAG.AOE, UNIT_TAG.ATTACKS_OTHER_LANES], campaign: { unlockMission: 7, initialWeight: 0.12, weightGrowth: 0.025 }, behavior: 'A disposable flying charge that detonates and splashes enemies beside its target.', graphic: 'firefly' }),
