...
export const UNIT_TYPES = Object.freeze({
  grunt: unit({ key: 'grunt', name: 'Grunt', role: UNIT_ROLE.MELEE, cost: 20, hp: 42, attack: 9, range: 1, campaign: { unlockMission: 0, initialWeight: 0.5, weightGrowth: 0.005 }, behavior: 'A dependable melee fighter who stops behind anything in the way.', graphic: 'grunt' }),
  skitter: unit({ key: 'skitter', name: 'Skitter', role: UNIT_ROLE.MELEE, cost: 12, hp: 24, attack: 5, range: 1, tags: [UNIT_TAG.SCATTER, UNIT_TAG.AI_ONLY], campaign: { unlockMission: 99, initialWeight: 0 }, behavior: 'A weak factory-spawned fighter that scatters into an open side lane when blocked.', graphic: 'skitter' }),
  samurai: unit({ key: 'samurai', name: 'Samurai', role: UNIT_ROLE.MELEE, cost: 27, hp: 38, attack: 11, range: 1, tags: [UNIT_TAG.SWIVEL], campaign: { unlockMission: 2, initialWeight: 0.16, weightGrowth: 0.03 }, behavior: 'A disciplined melee fighter that can pivot toward targets in nearby lanes.', graphic: 'rifleman' }),
  ...
  sniper: unit({ key: 'sniper', name: 'Sniper', role: UNIT_ROLE.RANGED, cost: 31, hp: 20, attack: 12, range: 4, campaign: { unlockMission: 0, initialWeight: 0.2, weightGrowth: 0.035 }, behavior: 'Engages distant ground targets that remain in the same lane.', graphic: 'marksman', animation: { attack: ATTACK_ANIMATION.LASER } }),
  ...
  mortar: unit({ key: 'mortar', name: 'Arty', role: UNIT_ROLE.RANGED, cost: 39, hp: 24, attack: 17, range: 3, tags: [UNIT_TAG.SWIVEL], campaign: { unlockMission: 7, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'Bombards ground targets within range by swiveling across lanes.', graphic: 'artillery', animation: { attack: ATTACK_ANIMATION.LOB } }),
