...
export const UNIT_TYPES = Object.freeze({
  ...
  gunner: unit({ key: 'gunner', name: 'Gunner', role: UNIT_ROLE.RANGED, cost: 27, hp: 32, attack: 9, range: 2, tags: [UNIT_TAG.ANTI_AIR], campaign: { unlockMission: 2, initialWeight: 0.28, weightGrowth: 0.04 }, behavior: 'A short-range automatic gunner able to engage both ground and flying targets.', graphic: 'gunner', animation: { attack: ATTACK_ANIMATION.LASER } }),
  ...
  ram: unit({ key: 'ram', name: 'Ram', role: UNIT_ROLE.SPECIALIST, cost: 27, hp: 58, attack: 0, range: 1, tags: [UNIT_TAG.PUSH], campaign: { unlockMission: 2, initialWeight: 0.24, weightGrowth: 0.04 }, behavior: 'Pushes an adjacent enemy backward and advances into the space it leaves.', graphic: 'ram' }),
  ...
  sniper: unit({ key: 'sniper', name: 'Marksman', role: UNIT_ROLE.RANGED, cost: 32, hp: 22, attack: 13, range: 4, campaign: { unlockMission: 1, initialWeight: 0.34, weightGrowth: 0.04 }, behavior: 'Engages distant ground targets that remain in the same lane.', graphic: 'marksman', animation: { attack: ATTACK_ANIMATION.LASER } }),
  fusilier: unit({ key: 'fusilier', name: 'Fusilier', role: UNIT_ROLE.RANGED, cost: 36, hp: 28, attack: 10, range: 3, tags: [UNIT_TAG.FORMATION], campaign: { unlockMission: 5, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'A formation rifle unit that stays in lock step with allied Formation units.', graphic: 'fusilier', animation: { attack: ATTACK_ANIMATION.LASER } }),
  flak: unit({ key: 'flak', name: 'Flak', role: UNIT_ROLE.SPECIALIST, cost: 35, hp: 24, attack: 12, range: 3, tags: [UNIT_TAG.ANTI_AIR, UNIT_TAG.SWIVEL], campaign: { unlockMission: 4, initialWeight: 0.18, weightGrowth: 0.035 }, behavior: 'An anti-air specialist that can swivel toward flying targets in nearby lanes.', graphic: 'flak', animation: { attack: ATTACK_ANIMATION.MISSILE } }),
  bertha: unit({ key: 'bertha', name: 'Bertha', role: UNIT_ROLE.RANGED, cost: 55, hp: 28, attack: 34, range: 5, tags: [UNIT_TAG.AOE, UNIT_TAG.RELOAD, UNIT_TAG.SWIVEL], campaign: { unlockMission: 6, initialWeight: 0.1, weightGrowth: 0.025 }, behavior: 'Fires a powerful long-range blast that damages nearby enemies, then reloads for two turns.', graphic: 'artillery', animation: { attack: ATTACK_ANIMATION.LOB } }),
  bomber: unit({ key: 'bomber', name: 'Demolisher', role: UNIT_ROLE.SPECIALIST, cost: 29, hp: 25, attack: 44, range: 1, tags: [UNIT_TAG.BOMB, UNIT_TAG.AOE], campaign: { unlockMission: 3, initialWeight: 0.2, weightGrowth: 0.04 }, behavior: 'Detonates at its own position when an enemy comes within range or when it is destroyed.', graphic: 'demolisher' }),
  ...
  sidestepper: unit({ key: 'sidestepper', name: 'Ranger', role: UNIT_ROLE.SPECIALIST, cost: 25, hp: 36, attack: 10, range: 2, tags: [UNIT_TAG.AGILE, UNIT_TAG.SWIVEL], campaign: { unlockMission: 3, initialWeight: 0.2, weightGrowth: 0.04 }, behavior: 'Dodges the first attack by slipping into an open adjacent lane, and can swivel toward targets in other lanes.', graphic: 'ranger', animation: { attack: ATTACK_ANIMATION.LASER } }),
  infiltrator: unit({ key: 'infiltrator', name: 'Infiltrator', role: UNIT_ROLE.SPECIALIST, cost: 29, hp: 26, attack: 13, range: 1, tags: [UNIT_TAG.AGILE, UNIT_TAG.STEALTH], campaign: { unlockMission: 5, initialWeight: 0.16, weightGrowth: 0.03 }, behavior: 'Dodges the first attack by slipping into an open adjacent lane and remains untargetable until an enemy becomes adjacent.', graphic: 'infiltrator' }),
