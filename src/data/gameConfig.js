...
export const UNIT_TYPES = Object.freeze({
  ...
  commander: unit({ key: 'commander', name: 'Commander', role: UNIT_ROLE.MELEE, techLevel: 3, cost: 72, hp: 120, attack: 18, range: 1, aura: { effect: AURA_EFFECT.DAMAGE, range: 2, value: 3 }, tags: [UNIT_TAG.ENHANCE], campaign: { unlockMission: 5, initialWeight: 0.08, weightGrowth: 0.018 }, behavior: 'An elite melee leader with heavy front-line stats who amplifies the attacks of nearby allies. Multiple damage boosts do not stack.', graphic: 'bulwark' }),
