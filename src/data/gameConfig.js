...
export const UNIT_TYPES = Object.freeze({
  ...
  mine: unit({ key: 'mine', name: 'Mine', role: UNIT_ROLE.SPECIALIST, techLevel: 2, cost: 28, hp: 18, attack: 44, range: 1, tags: [UNIT_TAG.BOMB, UNIT_TAG.AOE, UNIT_TAG.STATIONARY, UNIT_TAG.AI_ONLY], campaign: { unlockMission: 2, initialWeight: 0.12, weightGrowth: 0.025 }, behavior: 'A fragile enemy-only explosive trap that detonates on contact or destruction and damages adjacent enemies.', graphic: 'mine' }),
