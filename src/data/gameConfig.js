...
export const UNIT_TYPES = Object.freeze({
  ...
  sniper: unit({ key: 'sniper', name: 'Sniper', role: UNIT_ROLE.RANGED, techLevel: 1, cost: 31, hp: 20, attack: 12, range: 5, campaign: { unlockMission: 0, initialWeight: 0.2, weightGrowth: 0.035 }, behavior: 'Engages very distant ground targets that remain in the same lane.', graphic: 'marksman' }),
