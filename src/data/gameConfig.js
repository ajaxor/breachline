...
export const UNIT_TAG = Object.freeze({
  AGILE: 'agile', STATIONARY: 'stationary', SWIVEL: 'swivel', FAST_ATTACK: 'fast-attack', STEALTH: 'stealth', AI_ONLY: 'ai-only', FLYING: 'flying', ANTI_AIR: 'anti-air', BOMB: 'bomb', AOE: 'aoe', HEAL: 'heal', SHIELD: 'shield', ENHANCE: 'enhance', STUN_FIELD: 'stun-field', JAMMER: 'jammer', SALVO: 'salvo', PUSH: 'push', CHARGE: 'charge', RELOAD: 'reload', FORMATION: 'formation', THORNS: 'thorns', FACTORY: 'factory',
});
...
export const UNIT_TYPES = Object.freeze({
  grunt: unit({ key: 'grunt', name: 'Grunt', role: UNIT_ROLE.MELEE, cost: 20, hp: 42, attack: 9, range: 1, campaign: { unlockMission: 0, initialWeight: 1 }, behavior: 'A dependable melee fighter who stops behind anything in the way.', graphic: 'rifleman' }),
  gunner: unit({ key: 'gunner', name: 'Gunner', role: UNIT_ROLE.RANGED, cost: 26, hp: 30, attack: 9, range: 2, tags: [UNIT_TAG.ANTI_AIR], campaign: { unlockMission: 2, initialWeight: 0.28, weightGrowth: 0.04 }, behavior: 'A short-range automatic gunner able to engage both ground and flying targets.', graphic: 'gunner', animation: { attack: ATTACK_ANIMATION.LASER } }),
  tank: unit({ key: 'tank', name: 'Bulwark', role: UNIT_ROLE.MELEE, cost: 42, hp: 110, attack: 14, range: 1, campaign: { unlockMission: 2, initialWeight: 0.24, weightGrowth: 0.04 }, behavior: 'A heavily armored front-line unit built to hold a lane.', graphic: 'bulwark' }),
  ram: unit({ key: 'ram', name: 'Ram', role: UNIT_ROLE.SPECIALIST, cost: 30, hp: 64, attack: 0, range: 1, tags: [UNIT_TAG.PUSH], campaign: { unlockMission: 2, initialWeight: 0.24, weightGrowth: 0.04 }, behavior: 'Pushes an adjacent enemy backward and advances into the space it leaves.', graphic: 'ram' }),
  ...
  sniper: unit({ key: 'sniper', name: 'Marksman', role: UNIT_ROLE.RANGED, cost: 31, hp: 20, attack: 12, range: 4, campaign: { unlockMission: 1, initialWeight: 0.34, weightGrowth: 0.04 }, behavior: 'Engages distant ground targets that remain in the same lane.', graphic: 'marksman', animation: { attack: ATTACK_ANIMATION.LASER } }),
  ...
  midge: unit({ key: 'midge', name: 'Midge', role: UNIT_ROLE.FLYING, cost: 17, hp: 12, attack: 4, range: 1, campaign: { unlockMission: 5, initialWeight: 0.13, weightGrowth: 0.025 }, behavior: 'A cheap swarm flyer that slips through formations and pecks at targets in its lane.', graphic: 'midge' }),
  flyer: unit({ key: 'flyer', name: 'Wasp', role: UNIT_ROLE.FLYING, cost: 34, hp: 20, attack: 9, range: 2, tags: [UNIT_TAG.SWIVEL], campaign: { unlockMission: 6, initialWeight: 0.16, weightGrowth: 0.03 }, behavior: 'A flexible aerial skirmisher that advances through units and swivels toward nearby lanes.', graphic: 'wasp', animation: { attack: ATTACK_ANIMATION.MISSILE } }),
