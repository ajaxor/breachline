...
export const UNIT_TYPES = Object.freeze({
  ...
  samurai: unit({ key: 'samurai', name: 'Samurai', role: UNIT_ROLE.MELEE, techLevel: 2, cost: 30, hp: 38, attack: 15, range: 1, tags: [UNIT_TAG.SWIVEL], campaign: { unlockMission: 2, initialWeight: 0.16, weightGrowth: 0.03 }, behavior: 'A disciplined melee fighter that hits very hard and can pivot toward targets in nearby lanes.', graphic: 'rifleman' }),
  ...
  pike: unit({ key: 'pike', name: 'Pike', role: UNIT_ROLE.MELEE, techLevel: 2, cost: 31, hp: 86, attack: 6, range: 1, tags: [UNIT_TAG.FORMATION], campaign: { unlockMission: 2, initialWeight: 0.17, weightGrowth: 0.03 }, behavior: 'A heavily protected formation fighter with very high durability and deliberately low attack power.', graphic: 'pike' }),
  ...
  tank: unit({ key: 'tank', name: 'Bulwark', role: UNIT_ROLE.MELEE, techLevel: 2, cost: 48, hp: 110, attack: 12, range: 1, campaign: { unlockMission: 1, initialWeight: 0.16, weightGrowth: 0.04 }, behavior: 'A heavily armored front-line unit built to hold a lane.', graphic: 'bulwark' }),
  dozer: unit({ key: 'dozer', name: 'Dozer', role: UNIT_ROLE.SPECIALIST, techLevel: 2, cost: 30, hp: 64, attack: 0, range: 1, tags: [UNIT_TAG.PUSH, UNIT_TAG.PLAYER_ONLY], campaign: { unlockMission: 0, initialWeight: 0.13, weightGrowth: 0.035 }, behavior: 'Pushes an adjacent enemy and every unit lined up behind it backward, then advances into the opened space. The push fails if the line would leave the battlefield.', graphic: 'dozer' }),
  ...
  sniper: unit({ key: 'sniper', name: 'Sniper', role: UNIT_ROLE.RANGED, techLevel: 1, cost: 38, hp: 20, attack: 12, range: 5, campaign: { unlockMission: 0, initialWeight: 0.2, weightGrowth: 0.035 }, behavior: 'Engages very distant ground targets that remain in the same lane.', graphic: 'marksman' }),
  fusilier: unit({ key: 'fusilier', name: 'Fusilier', role: UNIT_ROLE.RANGED, techLevel: 2, cost: 30, hp: 30, attack: 10, range: 3, tags: [UNIT_TAG.FORMATION], campaign: { unlockMission: 3, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'A formation rifle unit that stays in lock step with allied Formation units.', graphic: 'fusilier' }),
  ...
  flak: unit({ key: 'flak', name: 'Flak', role: UNIT_ROLE.RANGED, techLevel: 2, cost: 36, hp: 26, attack: 11, range: 3, tags: [UNIT_TAG.ANTI_AIR, UNIT_TAG.SWIVEL], campaign: { unlockMission: 3, initialWeight: 0.18, weightGrowth: 0.035 }, behavior: 'An anti-air ranged unit that can swivel toward flying targets in nearby lanes.', graphic: 'flak' }),
  ...
  amplifier: unit({ key: 'amplifier', name: 'Amplifier', role: UNIT_ROLE.SUPPORT, techLevel: 3, cost: 34, hp: 28, attack: 0, range: 2, aura: { effect: AURA_EFFECT.DAMAGE, range: 2, value: 3 }, tags: [UNIT_TAG.ENHANCE], campaign: { unlockMission: 5, initialWeight: 0.12, weightGrowth: 0.025 }, behavior: 'Adds 3 damage to attacks made by friendly units within two cells. Multiple amplifiers do not stack.', graphic: 'amplifier' }),
  disruptor: unit({ key: 'disruptor', name: 'Disruptor', role: UNIT_ROLE.SUPPORT, techLevel: 3, cost: 48, hp: 28, attack: 3, range: 3, tags: [UNIT_TAG.STUN, UNIT_TAG.SALVO, UNIT_TAG.SWIVEL, UNIT_TAG.RELOAD], campaign: { unlockMission: 5, initialWeight: 0.1, weightGrowth: 0.02 }, behavior: 'Fires lightning at every valid enemy within range, then reloads for two turns. Each hit stuns its target for two turns.', graphic: 'disruptor' }),
  ...
  sidestepper: unit({ key: 'sidestepper', name: 'Ranger', role: UNIT_ROLE.SPECIALIST, techLevel: 2, cost: 28, hp: 34, attack: 9, range: 2, tags: [UNIT_TAG.AGILE, UNIT_TAG.SWIVEL], campaign: { unlockMission: 2, initialWeight: 0.2, weightGrowth: 0.04 }, behavior: 'Dodges the first attack by slipping into an open adjacent lane, and can swivel toward targets in other lanes.', graphic: 'ranger' }),
  ...
  assassin: unit({ key: 'assassin', name: 'Assassin', role: UNIT_ROLE.SPECIALIST, techLevel: 3, cost: 34, hp: 16, attack: 16, range: 1, tags: [UNIT_TAG.CHARGE, UNIT_TAG.STEALTH], campaign: { unlockMission: 4, initialWeight: 0.13, weightGrowth: 0.028 }, behavior: 'A fragile stealth attacker that advances at double speed while hidden and deals double damage on its first attack.', graphic: 'infiltrator' }),
  ...
  kite: unit({ key: 'kite', name: 'Kite', role: UNIT_ROLE.FLYING, techLevel: 3, cost: 64, hp: 14, attack: 10, range: 4, tags: [UNIT_TAG.SALVO], campaign: { unlockMission: 5, initialWeight: 0.11, weightGrowth: 0.02 }, behavior: 'A fragile long-range flyer that fires on every valid enemy in range while continuously advancing.', graphic: 'kite' }),
  ...
  stormwing: unit({ key: 'stormwing', name: 'Stormwing', role: UNIT_ROLE.FLYING, techLevel: 3, cost: 58, hp: 14, attack: 3, range: 3, tags: [UNIT_TAG.STUN, UNIT_TAG.SALVO, UNIT_TAG.ANTI_AIR, UNIT_TAG.SWIVEL, UNIT_TAG.RELOAD], campaign: { unlockMission: 5, initialWeight: 0.11, weightGrowth: 0.022 }, behavior: 'A flying anti-air disruptor that fires lightning at every valid ground and flying target within range, then reloads for two turns. Each hit stuns its target for two turns.', graphic: 'stormwing' }),
  mortar: unit({ key: 'mortar', name: 'Arty', role: UNIT_ROLE.RANGED, techLevel: 2, cost: 42, hp: 24, attack: 17, range: 3, tags: [UNIT_TAG.SWIVEL], campaign: { unlockMission: 4, initialWeight: 0.14, weightGrowth: 0.03 }, behavior: 'Bombards ground targets within range by swiveling across lanes.', graphic: 'artillery' }),
  ...
  teslaCoil: unit({ key: 'teslaCoil', name: 'Tesla Coil', role: UNIT_ROLE.STRUCTURE, techLevel: 3, cost: 88, hp: 120, attack: 8, range: 2, tags: [UNIT_TAG.STUN, UNIT_TAG.SWIVEL, UNIT_TAG.ANTI_AIR], animation: { attack: ATTACK_ANIMATION.LIGHTNING }, campaign: { unlockMission: 5, initialWeight: 0.1, weightGrowth: 0.022 }, behavior: 'A close-defense coil that shocks a nearby ground or flying target. Each hit stuns its target for two turns.', graphic: 'tesla-coil' }),
  factory: unit({ key: 'factory', name: 'Factory', role: UNIT_ROLE.STRUCTURE, techLevel: 3, cost: 74, hp: 165, attack: 0, range: 1, tags: [UNIT_TAG.FACTORY], production: { type: 'skitter', interval: 3 }, campaign: { unlockMission: 5, initialWeight: 0.08, weightGrowth: 0.018 }, behavior: 'A fortified enemy-only structure that produces a steady stream of weak Scatter infantry when the lane ahead is clear.', graphic: 'factory' }),
